                            ...
                            <div>
                                ...
                                <div class="mt-2 flex items-center">
                                    ...
                                    <button
                                        ...
                                        class="px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-colors"
                                    >
                                ...
                                <div v-for="(step, index) in form.steps" :key="index" class="bg-gray-600 rounded-lg p-5 border border-gray-500">
                                    <div class="flex justify-between items-center mb-4">
                                        <div class="flex items-center">
                                            <span class="flex items-center justify-center w-8 h-8 bg-blue-500 text-white rounded-full font-bold mr-3">
                                                {{ step.order }}
                                            </span>
